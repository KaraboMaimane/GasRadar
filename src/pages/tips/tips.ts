...
// import { PetrolTipsPage } from '../petrol-tips/petrol-tips';
...
gas = [
  { title: "Don't overcook your food.", description: "The heat energy that would be needed to bring down the food's temperature to room temperature will be saved."},
...
petrol = [
  ...
  constructor(public toastCtrl: ToastController,public modalCtrl: ModalController,private database:DatabaseProvider,public navCtrl: NavController, public navParams: NavParams) {
...
placeComment(newmessage){
  ...
  // petroltips() {
  //   const modal = this.modalCtrl.create(PetrolTipsPage);
  //   modal.present();
  // }
  // dieselview() {
  //   const modal = this.modalCtrl.create(DieselViewPage);
  //   modal.present();
  // }
  // gasview() {
  //   const modal = this.modalCtrl.create(GasViewPage);
  //   modal.present();
  // }
}
